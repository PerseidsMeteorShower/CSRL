...
if __name__ == "__main__":
    ...
    parser.add_argument('--simple_per_anchor', type=int, default=20, help='Simple number per anchor')
    ...
    parser.add_argument('--threshold_instance', type=int, default=5, help='After accumulate how many instances could a rule be considered as fully evaluated')
